...
maindir = '/network/lustre/iss02/cenir/analyse/irm/users/benoit.beranger/MEMOBRAIN';
...
e = exam(maindir,'nifti','MEMOBRAIN_Sujet\d_');
...
for ex = 1 : length(e)
    ...
    for run = 1 : length(run_list)
        e(ex).addSerie( [run_list{run} '$'],['run__' run_list{run}], 1)
    end
